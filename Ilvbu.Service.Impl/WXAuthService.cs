...
namespace Ilvbu.Service
{
    ...
    public class WXAuthService: IWXAuthService
    {
        ...
        //public WXAuthService(string appid, string appsecret, string redirect_uri, bool IsUserInfo = true)
        //{
        //    this.appid = appid;
        ...
        #endregion
        public void Error(string msg, Exception inner)
        {
            this.OnError?.Invoke(new Exception(msg, inner));
        }
